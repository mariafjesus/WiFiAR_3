...
{
    public Transform origin; // The transform from which to cast the ray ControllerPointerPose
    public GameObject cube; // The cube prefab to instantiate
    public GameObject wallPrefab; // The wall prefab to instantiate
    public Material lineMaterial;
    public Material mapLineMaterial;
    ...
    public OVRInput.Button interruptLineButton = OVRInput.Button.One;

    private List<List<Vector3>> pointGroups = new List<List<Vector3>>();
    private List<Vector3> allPoints = new List<Vector3>();
    private List<GameObject> placedCubes = new List<GameObject>();
    private List<WallConnection> wallConnections = new List<WallConnection>();
    private List<LineRenderer> lineRenderers = new List<LineRenderer>();
    private List<LineRenderer> mapLineRenderers = new List<LineRenderer>();

    private LineRenderer currentLineRenderer;
    private LineRenderer currentMapLineRenderer;
    ...
    Vector3 GetSnappedPoint(Vector3 point)
    {
        ...
        {
            // Check if there is any point within the threshold distance
    ...
    void PlacePoint(Vector3 hitPoint)
    {
        ...
        // Update line rendererers
        UpdateLineRenderer(currentLineRenderer, currentPoints);
        UpdateLineRenderer(currentMapLineRenderer, currentPoints); // Map lines
    }
